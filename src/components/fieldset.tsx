...
import type {DescriptionProps as HeadlessDescriptionProps, FieldProps as HeadlessFieldProps, FieldsetProps as HeadlessFieldsetProps, LabelProps as HeadlessLabelProps, LegendProps as HeadlessLegendProps} from '@headlessui/react';
